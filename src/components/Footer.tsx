            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8">
                    <div className="space-y-6">
                        <h3 className="font-serif text-3xl font-bold tracking-tight">Maka Studio</h3>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex space-x-6">
                            <a href="https://www.instagram.com/makastudio.space" target="_blank" rel="noopener noreferrer" className="p-3 bg-primary-foreground/10 hover:bg-primary-foreground/20 rounded-full transition-colors" aria-label="Instagram">
                ...
                <div className="mt-16 pt-8 border-t border-primary-foreground/20 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-sans text-primary-foreground/50">
                    <p>&copy; {new Date().getFullYear()} Maka Studio. All rights reserved.</p>
                    <div className="flex space-x-6">
